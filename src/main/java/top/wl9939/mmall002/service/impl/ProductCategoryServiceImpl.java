...
import top.wl9939.mmall002.vo.ProductVO;
...
public class ProductCategoryServiceImpl extends ServiceImpl<ProductCategoryMapper, ProductCategory>
    ...
    public List<ProductCategoryVO> getAllProductCategoryVO() {
        ...
        for (ProductCategoryVO levelOneProductCategoryVO :
                levelOneVO) {
            wrapper = new QueryWrapper();
            wrapper.eq("type", 2);
            ...
            for (ProductCategoryVO levelTwoProductCategoryVO :
                    levelTwoVO) {
                wrapper = new QueryWrapper();
                wrapper.eq("type", 3);
